...
public class JooFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_joo, container, false);

        DBHelper_Joo dbHelper = new DBHelper_Joo(getActivity());
        ...
        int indivisual = getAllColumnforJoo();
