...
public class LimFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_lim, container, false);

        DBHelper_Lim dbHelper = new DBHelper_Lim(getActivity());
        ...
        int indivisual = getAllColumnforLim();
