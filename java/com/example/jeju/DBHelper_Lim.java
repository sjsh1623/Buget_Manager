...
import com.example.jeju.Contract.*;

public class DBHelper_Lim extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Lim.db";
    public static final int DATABASE_VERSION = 3;
    private Context context;

    public DBHelper_Lim(FragmentActivity context) {
